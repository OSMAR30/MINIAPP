  ...
  return (
    <div style={{ padding: '20px 16px 160px', overflowY: 'auto', height: '100%' }}>
      ...
      <div style={{ padding: '0 16px 40px' }}>
        <button onClick={handleCancel} disabled={!running} style={{ width: 'auto', padding: '8px 20px', borderRadius: 12, border: '1px solid rgba(255,95,95,.3)', background: running ? 'rgba(255,95,95,.1)' : 'rgba(255,255,255,.05)', color: running ? '#ff5f5f' : 'rgba(255,255,255,.3)', fontSize: 12, fontWeight: 600, cursor: running ? 'pointer' : 'default', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, transition: 'all .2s', margin: '0 auto' }}>
          <LI name="XCircle" size={14} color={running ? '#ff5f5f' : 'rgba(255,255,255,.3)'} />
          Cancelar
        </button>
      </div>
